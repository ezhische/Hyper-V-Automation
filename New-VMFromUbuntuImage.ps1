...
$vm = New-VM -Name $VMName -Path $vmmsSettings.DefaultExternalDataRoot -Generation 2 -MemoryStartupBytes $MemoryStartupBytes -VHDPath $vhdxPath -SwitchName $SwitchName
